...
public class Shading {
	 ...
	 */
	public void addDiffuse(java.util.List<DirectionalLight> dirLights, Vector surfNormal) {
		if (diffShadingPresent) return;
		for (DirectionalLight dirLight :
				dirLights) {
			Vector lightNormal = dirLight.getDirection();
	...
	public void addShadows(java.util.List<DirectionalLight> dirLights, List<Solid> solids,
						   Vector surfPoint, Vector surfNormal) {
	...
	public void addSpecular(List<DirectionalLight> dirLights, Vector surfNormal,
							Vector viewerNormal, int phongK) {
		...
		for (DirectionalLight dirLight :
				dirLights) {
			Vector lightNormal = dirLight.getDirection().times(-1);
	...
	public void addReflections(Color reflectedColour, Vector viewerNormal, Vector surfaceNormal) {
